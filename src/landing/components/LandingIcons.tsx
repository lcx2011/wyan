...
export function BrainIcon({ className = 'w-6 h-6', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookOpenIcon({ className = 'w-6 h-6', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LaptopIcon({ className = 'w-6 h-6', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StarFilledIcon({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function QuoteIcon({ className = 'w-8 h-8', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KeyboardIcon({ className = 'w-5 h-5', size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
